...
crossdomaind tx crossdomain  update-decision-policy 0 0 '' 'finance' '{}' "" --from alice --yes --home ~/.mars --chain-id mars --node tcp://localhost:26659 --gas=auto --gas-adjustment=1.15
