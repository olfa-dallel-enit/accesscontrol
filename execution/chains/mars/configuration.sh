...
crossdomaind tx crossdomain  update-decision-policy 0 0 '' '' '{}' "2023-02-03 00:00:00" --from alice --yes --home ~/.mars --chain-id mars --node tcp://localhost:26659 --gas=auto --gas-adjustment=1.15
