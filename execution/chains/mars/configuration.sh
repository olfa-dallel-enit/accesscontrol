...
crossdomaind tx crossdomain  update-decision-policy 0 0 '' '' '{"notBefore":"2022-01-01 00:00:00","notAfter":"2026-01-01 00:00:00"}' "" --from alice --yes --home ~/.mars --chain-id mars --node tcp://localhost:26659 --gas=auto --gas-adjustment=1.15
