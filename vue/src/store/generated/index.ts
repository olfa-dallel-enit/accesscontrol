...
import CrossdomainCrossdomainCdaccesscontrol from './crossdomain/crossdomain.cdaccesscontrol'
...
export default { 
  ...
  CrossdomainCrossdomainCdaccesscontrol: load(CrossdomainCrossdomainCdaccesscontrol, 'crossdomain.cdaccesscontrol'),
