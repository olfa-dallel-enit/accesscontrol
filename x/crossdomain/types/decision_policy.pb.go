...
func (m *DecisionPolicy) GetLocation() string {
	if m != nil {
		return m.Location
	}
	return ""
...
func (m *DecisionPolicy) GetInterest() string {
	if m != nil {
		return m.Interest
	}
	return ""
...
var fileDescriptor_e8042ce219f13373 = []byte{
	...
	,
}
...
func (m *DecisionPolicy) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Interest) > 0 {
		...
		i = encodeVarintDecisionPolicy(dAtA, i, uint64(len(m.Interest)))
		i--
		dAtA[i] = 0x22
	}
	if len(m.Location) > 0 {
		...
		i = encodeVarintDecisionPolicy(dAtA, i, uint64(len(m.Location)))
		i--
		dAtA[i] = 0x1a
	}
	if m.Cost != 0 {
